...
let dbWarga = [
  ...
  //   lastName: 'Shakira',
  //   phone: '081287928317',
  //   email: 'shakira4@gmail.com',
  //   gender: 'Male',
  //   job: 'PNS',
  //   photo:
  //     'https://image.freepik.com/free-photo/smiling-confident-businesswoman-posing-with-arms-folded_1262-20950.jpg',
  //   address: 'Perumahan Griya Sarana Tangerang',
  // },
];
...
function printData() {
  ...
  // jika btn edit di klik, maka data selain ini dijalankan fungsi cancel
