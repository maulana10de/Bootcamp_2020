...
CREATE TABLE `tbpreview` (
  ...
  KEY `fkpreviewproduct_id_idx` (`idproduct`),
  CONSTRAINT `fkpreviewproduct_id` FOREIGN KEY (`idproduct`) REFERENCES `tbproducts` (`idproduct`) ON DELETE NO ACTION ON UPDATE NO ACTION
